...
class S3WorkspaceImportStorage(WorkspaceStorageMixin, S3ImportStorageBase):
    """Workspace-scope template for S3 imports.

    Workspace storages hold the connection config only; actual task syncing happens
    on a project-scope :class:`S3ImportStorage` whose ``parent_storage`` points here.
    """
