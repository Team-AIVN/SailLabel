...
class GCSImportStorage(ProjectStorageMixin, GCSImportStorageBase):
    ...
    parent_storage = models.ForeignKey(
        'io_storages.GCSWorkspaceImportStorage',
...
class GCSWorkspaceImportStorage(WorkspaceStorageMixin, GCSImportStorageBase):
    """Workspace-scope template for GCS imports. See LocalFilesWorkspaceImportStorage."""
