...
export const EmptyProjectsList = ({ openModal }) => {
  ...
  return (
    <div className={cn("empty-projects-page").toClassName()}>
      ...
      />
      <h1 className={cn("empty-projects-page").elem("header").toClassName()}>{t("projects.empty.heading")}</h1>
      <p>{t("projects.empty.description")}</p>
      <Button onClick={openModal} className="my-8" aria-label={t("projects.createProjectAriaLabel")}>
