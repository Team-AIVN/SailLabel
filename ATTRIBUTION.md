...
**SailLabel** is an open-source data-labeling platform that is a **derivative
...
Both Label Studio and SailLabel are distributed under the **Apache License,
Version 2.0**. SailLabel retains that same license. This document records the
...
|---|---|
| **Project** | SailLabel |
| **Copyright** | Copyright (c) 2025–2026 SailLabel contributors. |
...
2. **Section 4(b) — Mark changed files.**
   ...
   the "Summary of SailLabel changes" section below.
...
4. **Section 4(d) — Preserve the NOTICE file.**
   ...
   file, alongside SailLabel's own attribution. No upstream notices were
   removed.

SailLabel adds no additional restrictions to the rights granted by the Apache
License. All SailLabel modifications and additions are themselves licensed
under the Apache License, Version 2.0.

## Summary of SailLabel changes

SailLabel builds on Label Studio and adds, among other things:
...
- Re-branding of the user-facing application name to "SailLabel".
...
SailLabel is an **independent project** and is **not affiliated with, sponsored
...
the upstream project from which SailLabel is derived — a nominative,
...
Accordingly, the SailLabel product is branded as "SailLabel", not "Label
Studio".

## Third-party components

Label Studio and SailLabel depend on additional third-party open-source
...
## If you redistribute SailLabel

When redistributing SailLabel or a derivative of it, retain this
